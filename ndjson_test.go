...
func TestNdjsonCountWhere2(t *testing.T) {
	...
	filename := "testdata/apache_builds.json.zst"
...
func loadFile(filename string) []byte {
	...
	for {
		...
		if os.IsNotExist(err) {
			...
			resp, err := http.DefaultClient.Get("https://github.com/minio/simdjson-go/raw/refs/heads/master/" + filepath.Base(filename))
			if err != nil {
...
func BenchmarkNdjsonWarmCountStar(b *testing.B) {
	...
	ndjson := loadFile("testdata/gsoc-2018.json.zst")
